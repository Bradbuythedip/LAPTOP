...
```
sha256(web/index.html)   = 9f9e542d7018ee315e8238a02929a372310693391554876a5ef021500ceab950
...
**2157 assertions across twenty-three suites.**
...
`test/run-index.mjs` — 215, drives the $SNOOZE landing page. Most of it is about one
