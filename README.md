...
```
sha256(web/index.html)   = a577c4fb4800493e06cf22199608ded3c1747d9cd8246708b6e0d0c97f8b31ac
...
**2148 assertions across twenty-three suites.**
...
`test/run-index.mjs` — 206, drives the $SNOOZE landing page. Most of it is about one
