...
```
sha256(web/index.html)   = ff309dff03f402b178cbfa21a33873f4ca97cf510d3a7b4fe6378b061f717163
...
**2170 assertions across twenty-three suites.**
...
`test/run-index.mjs` — 228, drives the $SNOOZE landing page. Most of it is about one
